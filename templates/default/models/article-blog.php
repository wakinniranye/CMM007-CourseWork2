...
$pms_stylesheets[] = array('file' => '//cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.0.0-beta.2.4/assets/owl.carousel.min.css', 'media' => 'all');
$pms_stylesheets[] = array('file' => '//cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.0.0-beta.2.4/assets/owl.theme.default.min.css', 'media' => 'all');
$pms_javascripts[] = '//cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.0.0-beta.2.4/owl.carousel.min.js';

$pms_stylesheets[] = array('file' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-star-rating/3.5.5/css/star-rating.min.css', 'media' => 'all');
$pms_javascripts[] = '//cdnjs.cloudflare.com/ajax/libs/bootstrap-star-rating/3.5.5/js/star-rating.min.js';
                    ...
                    <div class="mb30 boxed">
                        <header>
                            ...
                            <div class="mb10 mt10 labels" dir="ltr">
                                <span class="label label-default"><i class="fas fa-fw fa-thumbtack"></i> <time itemprop="dateCreated datePublished dateModified" datetime="<?php echo date('c', $publish_date); ?>"><?php echo (!PMS_RTL_DIR) ? strftime(PMS_DATE_FORMAT, $publish_date) : strftime('%F', $publish_date); ?></time></span>
                                ...
                                <?php
                                $result_users = $pms_db->query('SELECT * FROM pm_user WHERE id IN('.$article['users'].')');
                        ...
                        <?php
                        $short_text = pms_strtrunc(pms_rip_tags($article['text']), 155);
                        $site_url = pms_getUrl(); ?>
                        ...
                        <div class="row">
                            ...
                            $my_articles = get_articles_page($pms_page_id);
                            
                            while(strval(key($my_articles)) != strval($pms_article_id) && key($my_articles) != null) next($my_articles);
                            ...
                            <div class="col-md-10 mt20">
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo DOCBASE.$page['alias']; ?>" class="btn btn-default"><?php echo $pms_texts['BACK']; ?></a>
                                    <?php
