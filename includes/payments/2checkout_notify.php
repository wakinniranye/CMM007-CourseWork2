...
if(isset($_POST['message_type']) && $_POST['message_type'] == 'ORDER_CREATED'){
    ...
    $hashSecretWord = PMS_SECRET_WORD;
    $hashSid = PMS_VENDOR_ID;
    ...
    if($result_booking !== false && $pms_db->last_row_count() > 0){
        ...
        if($vendor_id == PMS_VENDOR_ID && $payment_currency == PMS_DEFAULT_CURRENCY_CODE && $payment_amount == $expected_amount){
