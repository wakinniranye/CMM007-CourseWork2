...
class PdfToText
{
    ...
    protected static function extractText($data)
    {
        ...
        foreach($a_chunks as $chunk){
            // Look at each chunk decide ifwe can decode it by looking at the contents of the filter
            if(isset($chunk['data'])){
                ...
                if(trim($data) != ""){
                    // ifwe got data then attempt to extract it.
    ...
    {
        if(strpos($content, "/CIDInit") === 0) return "";
